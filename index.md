 ...
 <p>
  ...
  <p>
    <a href="https://edas.info/N35031"
       class="btn"
       style="background-color: transparent; border-color: #28a745; color: #28a745; font-weight: bold">
      Submit via EDAS
    </a>
  </p>
...
- Leverage real-time pose estimation, depth sensing, or markerless tracking for motor assessment and therapy.
- Integrate multimodal sensor fusion (e.g., wearables, cameras, depth, IMUs) for robust movement analysis.
- Design closed-loop serious games and adaptive XR systems for personalized rehabilitation and engagement.
- Automate motor scoring, functional assessment, and outcome prediction with AI methods.
- Explore XR-supported operating theatre scenarios, tele-mentoring, and training for surgeons and therapists.
- Bridge engineering innovation with clinical validation in real-world healthcare environments.
...
- AI-based motion analysis for rehabilitation and telemedicine.
...
- **Giovanni Lonia** – University of Messina / Università di Pisa – Email: glonia@unime.it  
- **Mirjam Bonanno** – Email: mirjam.bonanno@irccsme.it  
- **Rocco Salvatore Calabrò** – Email: roccos.calabro@irccsme.it  
- **Salvatore Livatino** – Email: s.livatino@herts.ac.uk  
